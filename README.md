...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hivwc7q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hivwc7q.containers.anotherwebservice.com/
...
```
git clone git@github.com:namelost2/container-hivwc7q.git
cd container-hivwc7q
```
...
```
docker attach container-hivwc7q
```
